...
class Pinjam extends CI_Controller
{
    ...
    public function pinjamAksi()
    {
        ...
        $data_booking = [
            ...
            'id_user' => $bo->id_user,
            'tgl_kembali' => date('Y-m-d', strtotime('+' . $lama . ' days', strtotime($tgl_sekarang))),
            'tgl_pengembalian' => '0000-00-00',
            'status' => 'Pinjam',
            'total_denda' => 0
        ];
        $this->ModelPinjam->simpanPinjam($data_booking);
    ...
    public function ubahStatus()
    {
        ...
        // Update stok dan dipinjam pada table buku
        ...
        $this->session->set_flashdata('pesan', '<div class="alert alert-message alert-success" role="alert">Status berhasil diubah</div>');
        redirect(base_url('pinjam'));
    }
}