...
<li class="nav-item active">
    <!-- Nav Item Dashboard -->
    <li class="nav-item">
        <a href="<?= base_url('laporan/laporanBuku'); ?>" class="nav-link pb-0">
            <i class="fas fa-fw fa-address-book"></i>
            <span>Laporan Data Buku</span>
        </a>
    </li>
    <li class="nav-item">
        <a href="<?= base_url('laporan/laporanAnggota'); ?>" class="nav-link pb-0">
            <i class="fa fa-fw fa-address-book"></i>
            <span>Laporan Data Anggota</span>
        </a>
    </li>
    <li class="nav-item">
        <a href="<?= base_url('laporan/laporanPinjam'); ?>" class="nav-link pb-0">
            <i class="fa fa-fw fa-address-book"></i>
